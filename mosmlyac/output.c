...
void output(void)
{
  ...
  output_debug();
  fprintf(output_file,
     "val yyact = vector_ %d (fn () => ((raise Fail \"parser\") : obj));\n",
     ntotalrules);
...
void output_yydefred(void)
{
    ...
    fprintf(output_file, "val yydefred = \"");
...
void goto_actions(void)
{
    ...
    fprintf(output_file, "val yydgoto = \"");
    output_short(k);
...
void output_base(void)
{
    ...
    fprintf(output_file, "val yysindex = \"");
    output_short(base[0]);
    ...
    fprintf(output_file, "val yyrindex = \"");
    ...
    fprintf(output_file, "val yygindex = \"");
...
void output_table(void)
{
    ...
    ++outline;
    fprintf(code_file, "val YYTABLESIZE = %d;\n", high);
    fprintf(output_file, "val yytable = \"");
...
void output_check(void)
{
    ...
    fprintf(output_file, "val yycheck = \"");
...
void output_transl(void)
{
  ...
  fprintf(code_file, "val yytransl = #[\n");
  for (i = 0; i < ntokens; i++) {
